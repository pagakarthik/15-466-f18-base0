...
for name in to_write:
    ...
    for poly in mesh.polygons:
        ...
        for i in range(0,3):
            ...
            if mesh.vertex_colors['Col'] is not None:
                col = mesh.vertex_colors['Col'].data[i].color
            else:
                print("WARNING: trying to export vertex colors, but object does not have colors - will output white")
